...
<div class="text-c">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			<a class="btn btn-primary radius" data-title="新增" onclick="addStoreGroup();" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 新增</a>
			<a class="btn btn btn-primary radius" data-title="修改" onclick="updStoreGroup();" href="javascript:;"><i class="Hui-iconfont">&#xe6df;</i> 修改</a>
			<a class="btn btn-warning radius" data-title="关联门店" onclick="storeGroupUnion();"href="javascript:;"><i class="Hui-iconfont">&#xe6f1;</i> 关联门店</a>
			<a href="javascript:;" onclick="removeGroupUnion()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 移除分组</a>
		</span>
