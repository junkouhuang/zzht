...
<div class="page-container">
	<span class="l" style="display: block;width: 227px;">
		<a href="javascript:;" onclick="offWindows()" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe632;</i> 保存</a>
		...
		<table class="table">
			<tr>
				...
				<td style="width:100%; white-space: normal;">
					<div name="provinces" id="provinces" style="width: 100%; height: 150px;float:left;border: 1px solid #ddd;padding: 17px 0 0 0;"  class="p10"></div>
				</td>
			</tr>
		</table>
	</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/batch-fb-store.js"></script>
</body>
</html>