...
<head>
  ...
  <body>
  <span class="r ml-10" style="margin-right: 20px;">共有图片：<strong id="total"></strong>1 张</span>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/goods_image_browse.js"></script>
</body>
</html>
